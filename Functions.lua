...
local EventHandlers = {
	...
	CHAT_MSG_ = function(msg, author, ...)
		...
		elseif
			string.match(string.lower(msg), "for the horde" or string.match(string.lower(msg), "for d[ae] horde"))
			and faction == "horde"
		then
		...
		elseif
			string.match(string.lower(msg), "for the alliance" or string.match(string.lower(msg), "for d[ae] alliance"))
			and faction == "alliance"
		then
			if not spamTimer then
